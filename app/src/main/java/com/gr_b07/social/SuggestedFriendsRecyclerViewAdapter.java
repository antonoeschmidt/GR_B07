...
public class SuggestedFriendsRecyclerViewAdapter extends RecyclerView.Adapter<SuggestedFriendsRecyclerViewAdapter.ViewHolder> {
    ...
    SuggestedFriendsRecyclerViewAdapter(Context context, List<Integer> imageViewAccount, List<String> username) {
